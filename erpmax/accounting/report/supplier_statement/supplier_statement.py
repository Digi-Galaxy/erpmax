...
def get_data(filters):
    ...
    transactions = get_supplier_transactions(supplier, from_date, to_date, company)
...
def get_supplier_transactions(supplier, from_date, to_date, company):
...
@frappe.whitelist()
def get_supplier_statement(supplier, from_date=None, to_date=None, company=None):
    """API endpoint for supplier statement"""
